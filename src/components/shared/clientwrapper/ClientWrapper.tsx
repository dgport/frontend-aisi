  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Spinning ring around the letter */}
        <div style={{
          position: 'absolute',
          width: '140px',
          height: '140px',
      ...
      <style jsx>{`
        ...
        @keyframes dot1 { animation-delay: 0s; }
        @keyframes dot2 { animation-delay: 0.2s; }
        @keyframes dot3 { animation-delay: 0.4s; }
      `}</style>
    </div>
  );
}
