...
"[project]/src/app/[locale]/signin/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SignInPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$routes$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authAPI"].login(formData);
            if (response.data) {
                router.push("/admin");
            }
        } catch (error) {
...
//# sourceMappingURL=src_app_%5Blocale%5D_signin_page_tsx_fe28b2ff._.js.map