(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__5fcf2fbe._.js", {
...
"[project]/src/messages/en/main.json (json)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v(JSON.parse("{\"hello\":\"Hello\"}"));}}),
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$server$2f$react$2d$server$2f$getRequestConfig$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__default__as__getRequestConfig$3e$__["getRequestConfig"])(async ({ requestLocale })=>{
    ...
    const messages = {
        main: (await __turbopack_context__.f({
            "../messages/en/main.json": {
                id: ()=>"[project]/src/messages/en/main.json (json)",
                module: ()=>Promise.resolve().then(()=>__turbopack_context__.i("[project]/src/messages/en/main.json (json)"))
            },
            "../messages/ka/main.json": {
                id: ()=>"[project]/src/messages/ka/main.json (json)",
                module: ()=>Promise.resolve().then(()=>__turbopack_context__.i("[project]/src/messages/ka/main.json (json)"))
            }
        }).import(`../messages/${locale}/main.json`)).default
    };
    return {
        locale,
        messages
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5fcf2fbe._.js.map